...
for train in train_size:
    for forecast_horizon in forecast_horizons:
        ...
        # create directory and save all outputs
        os.makedirs(f'outputs/test/Partition_horizon_{forecast_horizon}_train_{train}', exist_ok=True)

        # save forecast_df
        forecast_df.to_csv(f'outputs/test/Partition_horizon_{forecast_horizon}_train_{train}/forecast_df.csv', index=False)
