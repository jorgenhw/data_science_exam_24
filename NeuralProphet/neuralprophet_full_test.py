    ...
    for test in test_size:
        try:
            ...
            if train == 50:
                forecast_horizon = 12
                valid_size = 12/50
            elif train == 250 and test == 12:
                forecast_horizon = 12
                valid_size = 12/250
            elif train == 250 and test == 120:
                forecast_horizon = 60
                valid_size = 60/250
            elif train == 250 and test == 360:
                forecast_horizon = 60
                valid_size = 60/250
            elif train == 750 and test == 12:
                forecast_horizon = 12
                valid_size = 12/750
            elif train == 750 and test == 120:
                forecast_horizon = 120
                valid_size = 120/750
            elif train == 750 and test == 360:
            ...
            model_params, rmse_n, mape_n = train_neural_prophet(df_train, df_test, model_params, ip_params, op_params, forecast_horizon_test)
